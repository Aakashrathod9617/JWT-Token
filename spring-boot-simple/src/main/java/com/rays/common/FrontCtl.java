 ...
 * 
 * @Component public class FrontCtl extends HandlerInterceptorAdapter {
 * 
 ...
 * System.out.println("3333"); response.setContentType("application/json");
 * response.setStatus(HttpServletResponse.SC_UNAUTHORIZED);
 * response.setHeader("Access-Control-Allow-Origin", "http://localhost:4200");
 * response.setHeader("Access-Control-Allow-Methods",
 * "GET, POST, PUT, DELETE, OPTIONS");
 * response.setHeader("Access-Control-Allow-Headers", "*");
 * response.setHeader("Access-Control-Allow-Credentials", "true"); PrintWriter
 ...
 * throws Exception { System.out.println("inside post handler");
